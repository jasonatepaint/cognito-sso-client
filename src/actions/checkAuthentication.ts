 ...
 */
export const checkAuthenticationAction = (id: string, config: ClientConfig, state: AuthenticationState, options: CheckAuthenticationOptions, encodedClientState?: string) => {
