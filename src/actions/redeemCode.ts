import { getFromLocalStorage, removeFromLocalStorage } from "../storage";
...
export const redeemCodeAction = (
    ...
    const codeVerifier = getFromLocalStorage(CODE_VERIFIER_STORAGE_KEY);
