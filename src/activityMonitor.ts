...
export class ActivityMonitor {
	...
	static get initialized() { return initialized; }

	static get isActive() { return isActive; }

	static get pollInterval() { return POLL_INTERVAL_ACTIVITY_SECONDS; }
...
export const getTestContext = () => {
	return {
		activityEvents,
		intervalId,
		setLastActivityDate: function (date) { lastActivityDate = date; },
	};
};
